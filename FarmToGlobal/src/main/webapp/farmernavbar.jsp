...
<nav class="navbar">
    ...
    <ul class="navbar-links" style="list-style: none; padding: 0; margin: 0; display: flex;">
        <li><a href="/farmerhome">Home</a></li>
        <li><a href="/farmerprofile">Farmer Profile</a></li>
        <li><a href="/addproduct">Add Product</a></li> <!-- Add Product Link -->
        <li><a href="/viewallproducts">View Products</a></li> 
