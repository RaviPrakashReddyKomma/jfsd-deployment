...
<head>
    ...
    <style>
        body {
            background-color: lightgrey; /* Set background color for the page */
        }
...
<div class="container">
    <div class="form-content">
        <div class="form-title">Register as a Farmer</div> <form method="post" action="insertfarmer">
            ...
            <input type="text" class="form-control" name="fcname" required/>
            
            <label>Enter Location</label>
            <input type="text" class="form-control" name="flocation" required/>
            
            <label>Enter Contact</label>
            <input type="number" class="form-control" name="fcontact" required/>
